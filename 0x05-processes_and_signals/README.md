...
In this directory, There are practice exercises done in shell to learn about handling process ID's and signals in Bash with ps, pgrep, pkill, pkill, exit, and trap.
Tasks 📃
